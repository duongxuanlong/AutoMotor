...
#define LEFT_LIMIT_WHEEL_ANGLE_PER_ROUND      DEFAULT_WHEEL_ANGLE_PER_ROUND * 0.78f
#define RIGHT_LIMIT_WHEEL_ANGLE_PER_ROUND     DEFAULT_WHEEL_ANGLE_PER_ROUND * 0.81f
